...
struct GraphicInterface
{
    ...
    static void DrawPolygon(int x, int y, const std::vector<Vec2D> &vertices, Uint32 color);
    static void DrawFillPolygon(int x, int y, const std::vector<Vec2D> &vertices, Uint32 color);
